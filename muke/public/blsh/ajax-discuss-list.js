define(function(require,exports){
	...
	function discuss(options){
		...
		$itemContainer.before("<div class='sortlist'> \
			<div class='ordertab'> \
				<a href='javascript:void(0)' hidefocus='true' data-order='1' class='quealltab "+(!order?"onactive":"")+"'>全部</a>\
				<a href='javascript:void(0)' hidefocus='true' data-order='2' class='quealltab "+(order==1?"onactive":"")+"'>精华</a>\
			</div>\
		</div>");
	...
	function loaded(data){
		if(data.page_total==0&&!data.list.length){
			$itemContainer.html("<p class='unquestion'><span class='icon-ques'></span>此节暂无同学的问答</p>");
			$pageContainer.empty();
			return false;
		}
	}
