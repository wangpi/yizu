				...
				m.on("shown",function(){
					...
					var signInForm = $(this),
						refreshVerifyCode = function(){
							signInForm.find('.verify-img').attr('src', imoocSSO.verifyCodeUrl+"?t=" + new Date().getTime());
						};
			...
			return function(){
				...
				m.on("shown",function(){
					...
					var signUpForm = $(this),
						...
						refreshVerifyCode = function(){
							signUpForm.find('.verify-img').attr('src', imoocSSO.verifyCodeUrl+"?t=" + new Date().getTime());
						},
