...
<html><head>
    ...
    <link rel="stylesheet" href="./pwd/base.css" type="text/css">
    <link rel="stylesheet" href="./pwd/common-less_002.css" type="text/css">
    <script src="./pwd/push.js"></script><script src="./pwd/rt.js" async="" type="text/javascript"></script><script type="text/javascript">

        var OP_CONFIG={"module":"user","page":"setresetpwd","userInfo":{"uid":"3057710","nickname":"\u518d\u6253\u5c0f\u602a\u517d","head":"http:\/\/img.mukewang.com\/user\/54586313000139c902200220-80-80.jpg","usertype":"1","roleid":0}};
        var isLogin = 1;
        var is_choice = "";
    ...
    -->
    <link rel="stylesheet" href="./pwd/login-regist.css" type="text/css">
    <link rel="stylesheet" href="./pwd/settings.css" type="text/css">
    <link rel="stylesheet" href="./pwd/common-less.css" type="text/css">
    <link rel="stylesheet" href="./pwd/avtou-less.css" type="text/css">

    <script src="./pwd/jquery.js" async="" charset="utf-8"></script><script src="./pwd/seajs-text.js" async="" charset="utf-8"></script><script src="./pwd/common.js" async="" charset="utf-8"></script><script src="./pwd/string.js" async="" charset="utf-8"></script><script src="./pwd/suggest.js" async="" charset="utf-8"></script><script src="./pwd/store.js" async="" charset="utf-8"></script><script src="./pwd/json.js" async="" charset="utf-8"></script><script src="./pwd/im.js" async="" charset="utf-8"></script><script src="./pwd/setresetpwd.js" async="" charset="utf-8"></script><script src="./pwd/socket.js" async="" charset="utf-8"></script><script src="./pwd/validate.js" async="" charset="utf-8"></script><script src="./pwd/placeholder.js" async="" charset="utf-8"></script><script src="./pwd/messagebox.js" async="" charset="utf-8"></script><script src="./pwd/settingUitl.js" async="" charset="utf-8"></script><script src="./pwd/layer.js" async="" charset="utf-8"></script><link href="./pwd/layer.css" rel="stylesheet" charset="utf-8"></head>
<body>
        ...
        <div id="login-area">
            <ul class="clearfix logined">
                ...
                <li class="set_btn user-card-box">
                    <a id="header-avator" class="user-card-item" action-type="my_menu" href="http://www.imooc.com/u/3057710/courses" target="_self"><img src="./pwd/54586313000139c902200220-40-40.jpg" height="40" width="40">
                    ...
                    <div class="g-user-card">
                        <div class="card-inner">
                            <div class="card-top">
                                <a href="http://www.imooc.com/u/3057710/courses"><img src="./pwd/54586313000139c902200220-100-100.jpg" alt="再打小怪兽" class="l"></a>
        ...
        <div class="setting-right">
            <div class="setting-right-wrap wrap-boxes settings">
                ...
                <div class="pwd-reset-wrap setting-resetpwd">
                    <form method="post" id="resetpwdform" action="xiugaimima">

                        <div class="wlfg-wrap">
                            <label class="label-name" for="">当前密码</label>
                            <div class="rlf-group">
                                <input name="oldpwd" class="rlf-input rlf-input-pwd" placeholder="请输入当前密码" type="password">
                        ...
                        <div class="wlfg-wrap">
                            ...
                            <div class="rlf-group">
                                <span id="resetpwd-btn-save" hidefocus="true" aria-role="button" class="rlf-btn-green btn-block"><input type="submit" value="保存" ></span>
                            </div>
                        </div>
                    </form>
                </div>
...
<!--script-->
<script src="./pwd/ssologin.js"></script>
<script type="text/javascript" src="./pwd/sea.js"></script>
<script type="text/javascript" src="./pwd/sea_config.js"></script>
...
<div style="display: none">
    ...
    </script><script src="./pwd/h.js" type="text/javascript"></script><a href="http://tongji.baidu.com/hm-web/welcome/ico?s=f0cfcccd7b1393990c78efdeebff3968" target="_blank"><img src="./pwd/21.gif" height="20" border="0" width="20"></a>
    <script>
        (function(){
...
</div><script src="./pwd/user.htm" type="text/javascript"></script><script src="./pwd/iplookup.php" type="text/javascript"></script>
