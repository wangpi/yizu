...
<html><head>
    ...
    <script src="you_files/push.js"></script><script src="you_files/rt.js" async="" type="text/javascript"></script><script type="text/javascript">

        var OP_CONFIG={"module":"u","page":"articles","userInfo":{"uid":3057710,"nickname":"\u518d\u6253\u5c0f\u602a\u517d","head":"http:\/\/img.mukewang.com\/user\/5333a24400017ccd02000200-80-80.jpg","usertype":"1","roleid":0}};
        var isLogin = 1;
        var is_choice = "";
    ...
    <link rel="stylesheet" href="you_files/layer.css">




    <link rel="stylesheet" href="you_files/a.css" type="text/css">
    <script src="you_files/jquery.js" async="" charset="utf-8"></script><script src="you_files/seajs-text.js" async="" charset="utf-8"></script><script src="you_files/common.js" async="" charset="utf-8"></script><script src="you_files/string.js" async="" charset="utf-8"></script><script src="you_files/suggest.js" async="" charset="utf-8"></script><script src="you_files/store.js" async="" charset="utf-8"></script><script src="you_files/json.js" async="" charset="utf-8"></script><script src="you_files/im.js" async="" charset="utf-8"></script><script src="you_files/articles.js" async="" charset="utf-8"></script><script src="you_files/socket.js" async="" charset="utf-8"></script><script src="you_files/u_common.js" async="" charset="utf-8"></script><script src="you_files/layer.js" async="" charset="utf-8"></script></head>
<body>

<div id="header">
    <div class="page-container" id="nav">
        <div id="logo" class="logo"><a href="learn" target="_self" class="hide-text">慕课网</a></div>
        ...
        <div id="login-area">
            <ul class="clearfix logined">
                ...
                <li class="set_btn user-card-box">
                    <a id="header-avator" class="user-card-item" action-type="my_menu" href="http://www.imooc.com/u/3057710/courses" target="_self"><img src="<?php echo $re[0]['u_photo']?>" height="40" width="40">
                    ...
                    <div class="g-user-card">
                        <div class="card-inner">
                            <div class="card-top">
                                <a href="http://www.imooc.com/u/3057710/courses"><img src="<?php echo $re[0]['u_photo']?>" alt="再打小怪兽" class="l"></a>
                                <a href="courses"><span class="name text-ellipsis"><?php echo $re[0]['u_name']?></span></a>
                                <p class="meta">
                                    <a href="http://www.imooc.com/u/3057710/experience">经验<b id="js-user-mp"><?php echo $re[0]['jingyan']?></b></a>
                                    <a href="http://www.imooc.com/u/3057710/credit">积分<b id="js-user-credit"><?php echo $re[0]['jifen']?></b></a>            </p>

                                <a href="setprofile" class="icon-set setup"></a>
                            </div>
                            <!--
...
<div id="main">
    ...
    <div class="big-pic">
        <div class="user-info">
            ...
            <p class="user-desc">专业php开发</p>
            <div class="study-info clearfix">
                <div class="item study-time">
                    <em> 1小时32分</em><span>学习时长</span>
                </div>
    ...
    <div class="wrap">
        <div style="position: absolute; left: 0px; top: -175px;" class="slider">
            <div class="user-pic">
                ...
                <img class="img" src="<?php echo $re[0]['u_photo']?>" alt="">
            ...
            <ul>
                <li><a href="courses"><i class="icon-tick"></i><span>课程</span><b class="icon-drop_right"></b></a></li>
                ...
                <li><a href="setarticle" class="active"><i class="icon-blog"></i><span>文章</span><b class="icon-drop_right"></b></a></li>
                ...
                <div id="articlesList" class="articles-list">
                    <div class="list-item article-item clearfix">
                        ...
                        <div class="item-img r">
                            <a target="_blank" href="http://www.imooc.com/article/6077">
                                <img src="you_files/56fc6343000125e105610275-160-160.jpg" height="160" width="160">
                            </a>
                        </div>
                        <!-- text -->
                        <div class="item-txt l">
                            <h3 class="item-title">
                                ...
                                <a target="_blank" href="articledeta?aid=<?php echo $arr[0]['aid']?>" class="title-detail"><?php echo $arr[0]['aname']?></a>
                            </h3>

                            <p class="item-bd"><?php echo $arr[0]['acontent']?><a class="read-more" target="_blank" href="articledeta?aid=<?php echo $arr[0]['aid']?>">[查看全文]</a></p>

                            <div class="item-btm clearfix">

                                <ul class="l left-info">
                                    <li class="now-tag">
                                        <a class="item-tag" target="_blank" href="articlethree?atypetwo=<?php echo $arr[0]['atype']?>">后端开发</a>
                                    </li>
                                    <li class="pass-time"><span>11秒前</span></li>
                                </ul>

                                <div class="r right-info">
                                    <div class="favorite l">
                                        <i class="icon sns-thumb-up-outline"></i><em>点赞 0</em>
                                    </div>
                                    ...
                                    <div class="item-edit l">
                                        <i class="icon sns-edit"></i><a class="compile" target="_blank" href="http://www.imooc.com/article/edit/id/6077">编辑</a>
                                    </div>
...
<!--script-->
<script src="you_files/ssologin.js"></script>
<script type="text/javascript" src="you_files/sea.js"></script>
<script type="text/javascript" src="you_files/sea_config.js"></script>
...
<div style="display: none">
    ...
    </script><script src="you_files/h.js" type="text/javascript"></script><a href="http://tongji.baidu.com/hm-web/welcome/ico?s=f0cfcccd7b1393990c78efdeebff3968" target="_blank"><img src="you_files/21.gif" height="20" border="0" width="20"></a>
    <script>
        (function(){
...
</div><script src="you_files/user.htm" type="text/javascript"></script><script src="you_files/iplookup.php" type="text/javascript"></script>
