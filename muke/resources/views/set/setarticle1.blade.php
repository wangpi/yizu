...
<html><head>
    ...
    <script src="./kong/push.js"></script><script src="./kong/rt.js" async="" type="text/javascript"></script><script type="text/javascript">
    ...
    <link rel="stylesheet" href="./kong/layer.css">




    <link rel="stylesheet" href="./kong/a.css" type="text/css">
    <script src="./kong/jquery.js" async="" charset="utf-8"></script><script src="./kong/seajs-text.js" async="" charset="utf-8"></script><script src="./kong/common.js" async="" charset="utf-8"></script><script src="./kong/string.js" async="" charset="utf-8"></script><script src="./kong/suggest.js" async="" charset="utf-8"></script><script src="./kong/store.js" async="" charset="utf-8"></script><script src="./kong/json.js" async="" charset="utf-8"></script><script src="./kong/im.js" async="" charset="utf-8"></script><script src="./kong/articles.js" async="" charset="utf-8"></script><script src="./kong/socket.js" async="" charset="utf-8"></script><script src="./kong/u_common.js" async="" charset="utf-8"></script><script src="./kong/layer.js" async="" charset="utf-8"></script></head>
<body>
        ...
        <div id="login-area">
            <ul class="clearfix logined">
                ...
                <li class="set_btn user-card-box">
                    <a id="header-avator" class="user-card-item" action-type="my_menu" href="http://www.imooc.com/u/3057710/courses" target="_self"><img src="./kong/5333a24400017ccd02000200-40-40.jpg" height="40" width="40">
                    ...
                    <div class="g-user-card">
                        <div class="card-inner">
                            <div class="card-top">
                                <a href="http://www.imooc.com/u/3057710/courses"><img src="./kong/5333a24400017ccd02000200-100-100.jpg" alt="再打小怪兽" class="l"></a>
    ...
    <div class="wrap">
        <div style="position: absolute; left: 0px; top: -175px;" class="slider">
            <div class="user-pic">
                ...
                <img class="img" src="./kong/5333a24400017ccd02000200-200-200.jpg" alt="">
            ...
            <ul>
                ...
                <li><a href="article" class="active"><i class="icon-blog"></i><span>文章</span><b class="icon-drop_right"></b></a></li>
        ...
        <div class="u-container">
            ...
            <div id="articleMain" class="article-main">
                ...
                <p class="notattend">你还没有任何原创文章，快去<a href="addarticle" class="red" target="_blank">发表文章</a>吧</p>
            </div>
        </div><!-- .container end -->
    </div><!-- .wrap end-->
...
<!--script-->
<script src="./kong/ssologin.js"></script>
<script type="text/javascript" src="./kong/sea.js"></script>
<script type="text/javascript" src="./kong/sea_config.js"></script>
...
<div style="display: none">
    ...
    </script><script src="./kong/h.js" type="text/javascript"></script><a href="http://tongji.baidu.com/hm-web/welcome/ico?s=f0cfcccd7b1393990c78efdeebff3968" target="_blank"><img src="./kong/21.gif" height="20" border="0" width="20"></a>
    <script>
        (function(){
...
</div><script src="./kong/user.htm" type="text/javascript"></script><script src="./kong/iplookup.php" type="text/javascript"></script>
