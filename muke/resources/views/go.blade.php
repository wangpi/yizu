...
<div id="header">
    <div class="page-container" id="nav">
        ...
        <div class="g-menu-mini l">
            <a href="http://www.imooc.com/learn/530#" class="menu-ctrl">
                <i class="icon-menu"></i>
            </a>
            <ul class="nav-item l">
                <li>
            ...
            <ul class="header-unlogin clearfix">
                <li class="header-app">
                    ...
                    <div class="QR-download">
                        ...
                        <img src="./go/QR-code.jpg">
                    </div>
                </li>
                <li class="header-signin">
                    <a href="http://www.imooc.com/learn/530#" id="js-signin-btn">登录</a>
                </li>
                <li class="header-signup">
                    <a href="http://www.imooc.com/learn/530#" id="js-signup-btn">注册</a>
                </li>
            </ul>
        </div>
                <!--
