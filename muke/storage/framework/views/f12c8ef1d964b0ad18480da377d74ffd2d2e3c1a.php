...
<html><head>
    ...
    <link rel="stylesheet" href="./login/base.css" type="text/css">
    <link rel="stylesheet" href="./login/common-less.css" type="text/css">
    <script src="./login/push.js"></script><script src="./login/rt.js" async="" type="text/javascript"></script><script type="text/javascript">
    ...
    <link rel="stylesheet" href="./login/loginsign-less.css">
    <script type="text/javascript">
        var fromURL="";
    </script>

    <script src="./login/jquery.js" async="" charset="utf-8"></script><script src="./login/seajs-text.js" async="" charset="utf-8"></script><script src="./login/common.js" async="" charset="utf-8"></script><script src="./login/string.js" async="" charset="utf-8"></script><script src="./login/suggest.js" async="" charset="utf-8"></script><script src="./login/store.js" async="" charset="utf-8"></script><script src="./login/json.js" async="" charset="utf-8"></script><script src="./login/im.js" async="" charset="utf-8"></script><script src="./login/newlogin.js" async="" charset="utf-8"></script><script src="./login/socket.js" async="" charset="utf-8"></script><script src="./login/placeholder.js" async="" charset="utf-8"></script><script src="./login/autocomplete.js" async="" charset="utf-8"></script><script src="./login/modal.js" async="" charset="utf-8"></script><script src="./login/validate.js" async="" charset="utf-8"></script></head>
<body>
            ...
            <div class="wrap-left">
                <div class="login-wrap">
                    <div class="wel-hd">
                        ...
                        <a href="http://www.imooc.com/user/newsignup/from_url/" class="on-register r">立即注册</a>
                    ...
                    <div class="form-controls">
                        <form class="valid-form" id="js-login-form" autocomplete="off">
                            ...
                            <div class="form-control">
                                <input id='email' class="ipt ipt-email" data-validate="email" autocomplete="off" placeholder="请输入登录邮箱" type="text">
                                <p class="tips"></p>
                            ...
                            <div class="form-control clearfix" id="js-login-verify" style="display: none">
                                ...
                                <a href="javascript:void(0)" class="verify-img-wrap js-verify-refresh"><img src="./login/verifycode.png" class="verify-img"></a>
                            ...
                            <div class="form-control clearfix">
                                <input class="btn btn-red login-submit btn-block r login" value="登录" type="button">
                            </div>
                        </form>
                    </div>
...
<!--script-->
<script src="./login/ssologin.js"></script>
<script type="text/javascript" src="./login/sea.js"></script>
<script type="text/javascript" src="./login/sea_config.js"></script>
...
<div style="display: none">
    ...
    </script><script src="./login/h.js" type="text/javascript"></script><a href="http://tongji.baidu.com/hm-web/welcome/ico?s=f0cfcccd7b1393990c78efdeebff3968" target="_blank"><img src="./login/21.gif" height="20" border="0" width="20"></a>
    <script>
        (function(){
...
</div><script src="./login/user.htm" type="text/javascript"></script><script src="./login/iplookup.php" type="text/javascript"></script>
