...
<div id="head" class="sig-head">
    <a href="learn"><img src="./forget/muke.jpg"/></a>
</div>
            ...
            <div class="page-forgotpwd">
                <div class="page-forgotpwd-wrap">
                    <div class="js-forgotpwd-form-wrap">
                        ...
                        <div class="link-info">
                            <h3>通过注册邮箱链接重设密码</h3>
                            <a class="right-back" href='#' id="out"> 返回登录</a>
                        </div>

                        <form id="js-forgot-form" action="yanzheng" method="post">
                            <p class="tips" id="js-g-forgot-error">&nbsp;</p>
                            <div class="form-control">
                                <input name="email" data-validate="email" class="ipt ipt-email" placeholder="请输入登录邮箱" type="text">
                                <p class="tips"></p>
                            </div>
                            <div class="form-control form-control-verify">
                                <input id="verify-ipt" name="captcha" maxlength="5" class="ipt" placeholder="请输入验证码" type="text">

                                <a onclick="javascript:re_captcha();" >
                                    <img src="<?php echo e(URL('hello/captcha/1')); ?>"  alt="验证码" title="刷新图片" width="200" height="40" id="c2c98f0de5a04167a9e427d883690ff6" border="1"></a>
...
<script>
    function re_captcha() {
        $url = "<?php echo e(URL('hello/captcha')); ?>";
        $url = $url + "/" + Math.random();
